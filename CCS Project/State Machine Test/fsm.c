...
{
  FSM_initParamSet, LOAD_PARAMSET, NULL, INIT, NULL, BUILD_PARAMSET, NULL, INIT, NULL, INIT, NULL, INIT, FSM_saveParamFlash, SAVE_FLASH,
  FSM_setPlayer, SET_PLAYER1, NULL, INIT, NULL, BUILD_PARAMSET, NULL, BUILD_PARAMSET, NULL, BUILD_PARAMSET, NULL, BUILD_PARAMSET, FSM_saveParamFlash, SAVE_FLASH,
  ...
  FSM_setMode, SET_GAMEMODE, NULL, SET_PLAYER1, NULL, SET_PLAYER2, NULL, SET_PLAYER2, NULL, SET_PLAYER2, NULL, SET_PLAYER2, FSM_saveParamFlash, SAVE_FLASH,
  FSM_initParamSet, LOAD_PARAMSET, NULL, SET_PLAYER2, NULL, SET_GAMEMODE, NULL, SET_GAMEMODE, NULL, SET_GAMEMODE, NULL, SET_GAMEMODE, FSM_saveParamFlash, SAVE_FLASH,
  ...
  FSM_saveParamFlash, LOAD_PARAMSET, FSM_saveParamFlash, INIT, NULL, SAVE_RAM, NULL, SAVE_RAM, NULL, SAVE_RAM, NULL, SAVE_RAM, FSM_saveParamFlash, SAVE_FLASH,
  NULL, SAVE_FLASH, NULL, SAVE_FLASH, NULL, SAVE_FLASH, NULL, SAVE_FLASH, NULL, SAVE_FLASH, NULL, SAVE_FLASH, FSM_init, INIT
};
...
void FSM_New (void)
{
  if (StateTable[ActState][NEW].ptrFunct != NULL)
    StateTable[ActState][NEW].ptrFunct();

  ActState = StateTable[ActState][NEW].NextState;
}
